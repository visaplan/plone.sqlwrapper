...
class ISQLWrapper(Interface):
    ...
    def insert(self, table, dict_of_values,
    ...
    def update(self, table, dict_of_values, where=None, query_data={},
               returning=None,
               commit=None):
        """
    ...
    def delete(self, table, where=None, query_data=None,
               returning=None,
               commit=None):
        """
